...
@Slf4j
@Component
public class DestinationFailedHandler extends AbstractDestinationEventHandler {
    ...
    public DestinationFailedHandler(DestinationReferenceDao destinationReferenceDao, WebHookDao webHookDao,
