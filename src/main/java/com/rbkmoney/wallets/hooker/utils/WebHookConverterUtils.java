...
public class WebHookConverterUtils {
    ...
    public static EventFilter generateEventFilter(Set<com.rbkmoney.wallets.hooker.domain.enums.EventType> eventTypes) {
    ...
    private static EventType resolveEventType(com.rbkmoney.wallets.hooker.domain.enums.EventType type) {
        switch (type) {
